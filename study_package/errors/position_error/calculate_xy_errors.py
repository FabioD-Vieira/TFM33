...
ex = ex[:99]
fig1 = plt.figure()
#fig1.suptitle("x", fontsize=20)
ax = fig1.add_subplot(111)
ax.tick_params(labelsize=20)
ax.set_xlabel("x (dm)", fontsize=20)
ax.set_ylabel("y (dm)", fontsize=20)
c1 = ax.matshow(ex)
...
ey = ey[:, :249]
fig2 = plt.figure()
# fig2.suptitle("y", fontsize=20)
ax2 = fig2.add_subplot(111)
ax2.tick_params(labelsize=20)
ax2.set_xlabel("x (dm)", fontsize=20)
ax2.set_ylabel("y (dm)", fontsize=20)
c2 = ax2.matshow(ey)
...
ax3.set_xlabel("x (dm)", fontsize=20)
ax3.set_ylabel("y (dm)", fontsize=20)
